      ...
      case 3: // Others View
        return Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildReadonlyField('Territory Code', (submission.territory != null && submission.territory!.isNotEmpty) ? submission.territory! : '-'),
            const SizedBox(height: 12),
            _buildReadonlyField('Territory Manager / Medrep', (submission.salesPerson != null && submission.salesPerson!.isNotEmpty) ? submission.salesPerson! : (submission.medrepEmail ?? '-')),
            const SizedBox(height: 12),
